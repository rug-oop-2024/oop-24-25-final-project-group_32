...
def create() -> Dataset:
    """
    Prompts the user to upload a file using streamlit and
    returns a dataset from that file.
    ...
    if uploaded_file is not None:
        ...
        refractored_data = Dataset.from_dataframe(df, uploaded_file.name,
                                                  uploaded_file.name, "1.0.0")
